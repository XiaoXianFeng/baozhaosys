...
namespace Box
{
    public partial class PrintItemSelectFrm : Form
    {
        ...
        public string ShebeiNoSeq
        {
            get;
            set;
        }

        public string ShebeiNo
        {
            get;
            set;
        }
        public string ShebeiNoBar
        {
            get;
            set;
        }
                ...
                using (var conn = new SQLiteConnection("Data Source=" + FilePath))
                {
                    ...
                    try
                    {
                        ...
                        using (SQLiteCommand command = conn.CreateCommand())
                        {
                            ...
                            command.Parameters["@Name"].Value = "ShebeiNo";
        ...
        private void PrintItemSelectFrm_Load(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(ShebeiNo))
            {
                ShebeiTB.Text = ShebeiNo;
            }
